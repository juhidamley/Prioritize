...
export default function MandelbrotBackground() {
  ...
  useEffect(() => {
    ...
    // Low render resolution, CSS-upscaled: it's a blurred 70%-opacity backdrop,
    // so 0.4 is visually indistinguishable at a quarter of the pixel cost.
    ...
    for (let i = 0; i < maxIter; i++) {
      palette[i * 4] = Math.floor(Math.sin(0.15 * i) * 127 + 128);
